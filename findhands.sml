...
fun saveAllImages name ext t =
  let val ids = getIds()
      val w = maxWidth ids
      val getName = fn i => padNum i w
      val save = fn i => saveImage (getName i) t i
  in Vector.map save ids end;

fun saveVideo name t =
...
findHands();
displayVideo 1;
saveImage "cvsl_out/f10.png" 0 10;
saveAllImages "cvsl_out/gray" "png" 1;
